    ...
    return declare(null, {
        ...
        _setupUI: function () {
            ...
            setTimeout(lang.hitch(this, function () {
                ...
                // Set the theme CSS
                styleString += ".appTheme{color:#fff;background-color:#396ab2}";
                styleString += ".appThemeHover:hover{color:#396ab2;background-color:#fff!important}";
                styleString += ".appThemeInverted{color:#312867;;background-color: #efefef;background-image: url(http://www.dvrpc.org/webmaps/phillyfreightfinder/lib/images/p5.png);}";
                // styleString += ".appThemeInvertedHover:hover{color:#BBE6FA;background-color:#396ab2!important}";
