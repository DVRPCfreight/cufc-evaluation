...
define({
 ...
    "displayText": "<h3>Critical Urban Freight Corridor Feedback</h3><p>We are working to designate local candidate corridors of the National Highway Freight Network in Pennsylvania. Based on freight activity, connectivity, and network continuity considerations, DVRPC has identified five potential corridors in the Pennsylvania counties of the region. <b>We are asking our stakeholders to provide feedback on these corridors.</b></p><p>Public input will close on <b>February 8, 2017</b> and the recommended corridors will be submitted to the DVRPC Board for approval. Upon approval, the recommendations will be sent to PennDOT for potential inclusion in the 141 miles of CUFCs designated statewide.</p><div style='border:1px solid #dfdfdf;background-color:#efefef;padding:5px 15px;'><h4 style='border-bottom:1px solid #312867;color:##396ab2;'>How to use this tool</h4><p>This tool allows for you the user to vote for and comment on each recommended corridor. The orange facilities on the map represent the proposed Critical Urban Freight Corridors listed in the right sidebar. To provide feedback:<ol style='height:200px'><li>click on the facility in the map or select the name from the list in the sidebar to the right<br/><img width='402' style='border: 1px solid #ddd;' src='./images/list-item.png'/></li><li>to support the designation of a corridor click the heart symbol<br/><img width='77' src='./images/like.png'/></li><li>to oppose or provide additional comments click the comment symbol and fill out the form<br/><img width='77' src='./images/comment.png'/></li></ol><div onclick='killIt()' class='btn btnNormal dvrpcBtn' title='Click to get started'> Provide feedback </div></p></div><p>For additional feedback and other comments, please contact Michael Ruane at <a href='mailto:mruane@dvrpc.org'>mruane@dvrpc.org</a>.</p><h4 style='border-bottom:1px solid #312867;color:##396ab2;'>About CUFCs</h4><p>Under the FAST Act Metropolitan Planning Organizations and State Departments of Transportation are tasked with designating Critical Urban and Rural Freight Corridors. Inclusion in the NHFS provides the potential for funding through freight programs created in the FAST Act. Corridors eligible for inclusion provide key connections between the Primary Highway Freight System (PHFS), intermodal facilities, and important freight activity centers. The PHFS, mapped in blue, is considered the primary national freight highway network. The proposed Critical Urban Freight Corridors (CUFC), mapped in orange, provide the missing links at a regional level. Statewide PennDOT is able to designate a total of 141 miles of CUFCs.</p><p>For detailed information please go to <a href='http://ops.fhwa.dot.gov/freight/infrastructure/nfn/index.htm'>the FHWA website on the NHFN.</a>",
    "color": "#396ab2",
    "featureLayer": {
